...
public class adapteraklat11 extends RecyclerView.Adapter<adapteraklat11.viewholder>{
    Context context;
    ...
    public adapteraklat11(Context con, ArrayList<foodtypes> myliste)
    {
        this.context=con;
...
*/
    ...
    @NonNull
    @Override
    public adapteraklat11.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myview= LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.typerow,parent,false);
        return new adapteraklat11.viewholder(myview);
    }

    @Override
    public void onBindViewHolder(@NonNull final adapteraklat11.viewholder holder, int position) {
