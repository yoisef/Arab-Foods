...
public class adapteraklat12 extends RecyclerView.Adapter<adapteraklat12.viewholder>{
    Context context;
    ...
    public adapteraklat12(Context con, ArrayList<foodtypes> myliste)
    {
        this.context=con;
...
*/
    ...
    @NonNull
    @Override
    public adapteraklat12.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myview= LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.typerow,parent,false);
        return new adapteraklat12.viewholder(myview);
    }

    @Override
    public void onBindViewHolder(@NonNull final adapteraklat12.viewholder holder, int position) {
