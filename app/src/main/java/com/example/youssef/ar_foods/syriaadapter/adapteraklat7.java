...
public class adapteraklat7 extends RecyclerView.Adapter<adapteraklat7.viewholder>{
    Context context;
    ...
    public adapteraklat7(Context con, ArrayList<foodtypes> myliste)
    {
        this.context=con;
...
*/
    ...
    @NonNull
    @Override
    public adapteraklat7.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myview= LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.typerow,parent,false);
        return new adapteraklat7.viewholder(myview);
    }

    @Override
    public void onBindViewHolder(@NonNull final adapteraklat7.viewholder holder, int position) {
